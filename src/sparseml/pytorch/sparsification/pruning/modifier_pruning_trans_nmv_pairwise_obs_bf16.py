...
__all__ = [
    ...
    "BF16OBSTransnmvpairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class BF16OBSTransnmvpairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return BF16OBSTransnmvpairPruningParamsScorer(
            params=params,
...
class BF16OBSTransnmvpairPruningParamsScorer(PruningParamsGradScorer):
    """
