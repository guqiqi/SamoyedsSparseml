...
__all__ = [
    "BF16OBSnmvpairPruningModifier",
    "BF16OBSnmvpairPruningParamsScorer",
]
...
@PyTorchModifierYAML()
class BF16OBSnmvpairPruningModifier(BaseGradualPruningModifier):
    """
    ...
    def initialize(
        ...
        **kwargs,
        ...
        """
        _LOGGER.debug("Initializing BF16OBSnmvpairPruningModifier")
        if (
    ...
    def _get_scorer(self, params: List[Parameter]) -> PruningParamsGradScorer:
        ...
        """
        return BF16OBSnmvpairPruningParamsScorer(
            params=params,
...
class BF16OBSnmvpairPruningParamsScorer(PruningParamsGradScorer):
    """
    ...
    def score_parameters(self) -> List[Tensor]:
        ...
        if self._is_main_proc:
            for i, finv in enumerate(self._finvs):
                ...
                trans_params = self._params[i].data
                ...
                scores[i] = scores0.reshape(trans_params.shape).to(self._devices[i])
