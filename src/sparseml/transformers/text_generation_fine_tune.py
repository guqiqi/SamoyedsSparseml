...
def main(**kwargs):
    ...
    tokenized_datasets = _get_tokenized_datasets(
...
def _get_tokenized_datasets(dataset, data_args, tokenizer: "AutoTokenizer", splits: None, do_train: False, do_eval: False, do_predict: False):
    """
